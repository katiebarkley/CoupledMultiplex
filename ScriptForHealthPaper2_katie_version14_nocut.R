...
outputfolder<-file.path("output14_nocut","results14_nocut")
...
for(t in 2:time){
  ...
  if(t==2){
    ...
    dis_mat  <-network_rewire_concern(net=dis_mat,concern=start[[2]],concern.prev=rep(0,g_pop_info$g_pop),g_pop_info=g_pop_info,prop_cutg=0.25,prop_cut=0,
  ...
  if(t>2){
    ...
    dis_mat  <-network_rewire_concern(net=dis_mat,concern=current[[2]],
                                      ...
                                      g_pop_info=g_pop_info,prop_cut=0,prop_cutg=0,cut_to=0.001,
...
saveRDS(OUT, file.path(outputfolder,paste0("nets",params1$NetSelect[nt],"mods",params2$ModSelect[md],"group",g,"rep",r,".RDS")))
...
saveRDS(OUT_G, file.path(outputfolder,paste0("group_nets",params1$NetSelect[nt],"mods",params2$ModSelect[md],"group",g,"rep",r,".RDS")))
