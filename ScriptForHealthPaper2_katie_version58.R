...
saveRDS(OUT, file.path(outputfolder,paste0("nets",params1$NetSelect[nt],"mods",params2$ModSelect[md],"group",g+4,"rep",r,".RDS")))
...
saveRDS(OUT_G, file.path(outputfolder,paste0("group_nets",params1$NetSelect[nt],"mods",params2$ModSelect[md],"group",g+4,"rep",r,".RDS")))
