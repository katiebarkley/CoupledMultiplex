...
saveRDS(OUT, file.path(outputfolder,paste0("hc_nets",params1$NetSelect[nt],"mods",params2$ModSelect[md],"group",9,"rep",r,".RDS")))
...
saveRDS(OUT_G, file.path(outputfolder,paste0("hc_group_nets",params1$NetSelect[nt],"mods",params2$ModSelect[md],"group",9,"rep",r,".RDS")))
